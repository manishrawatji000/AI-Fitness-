...
var CenterCrop = class extends Layer {
  ...
  centerCrop(inputs, hBuffer, wBuffer, height, width, inputHeight, inputWidth, dtype) {
    return tidy(() => {
      ...
      if (isRank3) {
        return cast3(getExactlyOneTensor(unstack(cropped)), dtype);
      }
      return cast3(cropped, dtype);
    });
  }
  upsize(inputs, height, width, dtype) {
    return tidy(() => {
      const outputs = resizeBilinear2(inputs, [height, width]);
      return cast3(outputs, dtype);
    });
  }
  call(inputs, kwargs) {
    return tidy(() => {
...
function fusedConv2D(args) {
  ...
  if (bias) {
    ...
    if (dataFormat === "NCHW" && bias.shape.length === 1 && bias.shape[0] !== 1) {
      ...
      result = add2({ inputs: { a: result, b: reshapedBias }, backend: backend2 });
...
export {
  ...
  version6 as version_cpu,
  version4 as version_layers,
  version3 as version_webgl,
  webgl,
